...
c-----------------------------------------------------------------------
c
      parameter ( Max_Nr_of_Equations    =    30 )
c
      parameter ( Max_Non_Zeros_Jacobian =   900 )
c
      parameter ( Max_Non_Zeros_B        =   900 )
c
      parameter ( Max_Lower_Diagonals    =    30 )
c
      parameter ( Max_Upper_Diagonals    =    30 )
c
