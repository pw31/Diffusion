...
************************************************************************
     ...
     >               d2m,d2r1,d2r2
      ...
      implicit none
      integer :: i
      real :: k,h,df,df2,hm1,hm2,hp1,hp2,x
     ...
     >       / ((hp1-hp2)*hp2*(hm1+hp2)*(hm2+hp2))
      ...
      !--- compute 1st and 2nd derivative coeff. at i=2,N-1 ---
      hl2(2)  = zz(1) - zz(2)
      hl1(2)  = zz(3) - zz(2)
      hr1(2)  = zz(4) - zz(2)
      hr2(2)  = zz(5) - zz(2)
     ...
     >     /((hl1(2)-hl2(2))*hl2(2)*(-hr1(2)+hl2(2))
     >     *(-hr2(2)+hl2(2)))
      d2l1(2) =(2.0*(hr2(2)*hl2(2)+hr1(2)*(hr2(2)+hl2(2))+hl1(2)
     >     *(hr1(2)+hr2(2)+hl2(2))))/(hl1(2)*hr1(2)*hr2(2)*hl2(2))
      d2m(2)  =(2.0*(hr2(2)*hl2(2)+hr1(2)*(hr2(2)+hl2(2))))
     >     /(hl1(2)*(hl1(2)-hr1(2))*(hl1(2)-hr2(2))
     >     *(hl1(2)-hl2(2)))
      d2r1(2) =-(2.0*(hr2(2)*hl2(2) + hl1(2)*(hr2(2)+hl2(2))))
     >     /((hl1(2)-hr1(2))*hr1(2)*(hr1(2)-hr2(2))
     >     *(hr1(2)-hl2(2)))
      d2r2(2) =-(2.0*(hr1(2)*hl2(2) + hl1(2)*(hr1(2)+hl2(2))))
     >     /((hl1(2)-hr2(2))*hr2(2)*(-hr1(2)+hr2(2))
     >     *(hr2(2)-hl2(2))) 
      ...
      hr2(N-1)  = zz(N)   - zz(N-1)
      d1l2(N-1) = (hr1(N-1)*hl1(N-1)*hr2(N-1))/((hr1(N-1)-hl2(N-1))
     >     *hl2(N-1)*(-hl1(N-1)+hl2(N-1))*(hl2(N-1)-hr2(N-1)))
      d1l1(N-1) =(hr1(N-1)*hl2(N-1)*hr2(N-1))/((hr1(N-1)-hl1(N-1))
     >     *hl1(N-1)*(hl1(N-1)-hl2(N-1))*(hl1(N-1)-hr2(N-1)))
      d1m(N-1)  =(hl1(N-1)*hl2(N-1)*hr2(N-1))/(hr1(N-1)
     >     *(-hr1(N-1)+hl1(N-1))*(-hr1(N-1)+hl2(N-1))
     >     *(-hr1(N-1)+hr2(N-1)))
      d1r1(N-1) =-1.0/(hr1(N-1))-1.0/(hl1(N-1))-(hl2(N-1)+hr2(N-1))
     >     /(hl2(N-1)*hr2(N-1))
      d1r2(N-1) =(hr1(N-1)*hl1(N-1)*hl2(N-1))/((hr1(N-1)-hr2(N-1))
     >     *hr2(N-1)*(-hl1(N-1)+hr2(N-1))*(-hl2(N-1)+hr2(N-1)))

      d2l2(N-1) =-(2.0*(hl1(N-1)*hr2(N-1)+hr1(N-1)
     >     *(hl1(N-1)+hr2(N-1))))/((hr1(N-1)-hl2(N-1))
     >     *hl2(N-1)*(-hl1(N-1)+hl2(N-1))*(hl2(N-1)-hr2(N-1)))
      d2l1(N-1) =-(2.0*(hl2(N-1)*hr2(N-1)+hr1(N-1)
     >     *(hl2(N-1)+hr2(N-1))))/((hr1(N-1)-hl1(N-1))*hl1(N-1)
     >     *(hl1(N-1)-hl2(N-1))*(hl1(N-1)-hr2(N-1)))
      d2m(N-1)  =(2.0*(hl2(N-1)*hr2(N-1)+hl1(N-1)
     >     *(hl2(N-1)+hr2(N-1))))/(hr1(N-1)*(hr1(N-1)-hl1(N-1))
     >     *(hr1(N-1)-hl2(N-1))*(hr1(N-1)-hr2(N-1)))
      d2r1(N-1) =(2.0*(hl2(N-1)*hr2(N-1)+hl1(N-1)
     >     *(hl2(N-1)+hr2(N-1))+hr1(N-1)*(hl1(N-1)+hl2(N-1)+hr2(N-1))))
     >     /(hr1(N-1)*hl1(N-1)*hl2(N-1)*hr2(N-1))
      d2r2(N-1) =-(2.0* (hl1(N-1)*hl2(N-1)+hr1(N-1)
     >     *(hl1(N-1)+hl2(N-1))))/((hr1(N-1)-hr2(N-1))*hr2(N-1)
     >     *(-hl1(N-1)+hr2(N-1))*(-hl2(N-1)+hr2(N-1)))
