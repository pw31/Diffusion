...
************************************************************************
     ...
     >       / ((hp1-hp2)*hp2*(hm1+hp2)*(hm2+hp2))
      ...
      !--- compute 1st and 2nd derivative coeff. at i=2 and N-1 ---
      hl2  = zz(1) - zz(2)
      hl1  = zz(3) - zz(2)
      hr1  = zz(4) - zz(2)
      hr2  = zz(5) - zz(2)
      d1l2(2) =(hl1*hr1*hr2)/((hl1-hl2)*hl2*(-hr1+hl2)*(-hr2+hl2))
      d1l1(2) =-1.0/(hl1)-1.0/(hr1)-(hr2+hl2)/(hr2*hl2)
      d1m(2)  =(hr1*hr2*hl2)/(hl1*(-hl1+hr1)*(-hl1+hr2)*(-hl1+hl2))
      d1r1(2) =(hl1*hr2*hl2)/((hl1-hr1)*hr1*(hr1-hr2)*(hr1-hl2))
      d1r2(2) =(hl1*hr1*hl2)/((hl1-hr2)*hr2*(-hr1+hr2)*(hr2-hl2))
      
      d2l2(2) =-(2.0*(hr1*hr2+hl1*(hr1+hr2)))
     >     /((hl1-hl2)*hl2*(-hr1+hl2)*(-hr2+hl2))
      d2l1(2) =(2.0*(hr2*hl2+hr1*(hr2+hl2)+hl1
     >     *(hr1+hr2+hl2)))/(hl1*hr1*hr2*hl2)
      d2m(2)  =(2.0*(hr2*hl2+hr1*(hr2+hl2)))
     >     /(hl1*(hl1-hr1)*(hl1-hr2)*(hl1-hl2))
      d2r1(2) =-(2.0*(hr2*hl2 + hl1*(hr2+hl2)))
     >     /((hl1-hr1)*hr1*(hr1-hr2)*(hr1-hl2))
      d2r2(2) =-(2.0*(hr1*hl2 + hl1*(hr1+hl2)))
     >     /((hl1-hr2)*hr2*(-hr1+hr2)*(hr2-hl2)) 

      hl2  = zz(N-4) - zz(N-1)
      hl1  = zz(N-3) - zz(N-1)
      hr1  = zz(N-2) - zz(N-1)
      hr2  = zz(N)   - zz(N-1)
      d1l2(N-1) = (hr1*hl1*hr2)/((hr1-hl2)*hl2*(-hl1+hl2)*(hl2-hr2))
      d1l1(N-1) =(hr1*hl2*hr2)/((hr1-hl1)*hl1*(hl1-hl2)*(hl1-hr2))
      d1m(N-1)  =(hl1*hl2*hr2)/(hr1*(-hr1+hl1)*(-hr1+hl2)*(-hr1+hr2))
      d1r1(N-1) =-1.0/(hr1)-1.0/(hl1)-(hl2+hr2)/(hl2*hr2)
      d1r2(N-1) =(hr1*hl1*hl2)/((hr1-hr2)*hr2*(-hl1+hr2)*(-hl2+hr2))

      d2l2(N-1) =-(2.0*(hl1*hr2+hr1*(hl1+hr2)))/((hr1-hl2)
     >     *hl2*(-hl1+hl2)*(hl2-hr2))
      d2l1(N-1) =-(2.0*(hl2*hr2+hr1*(hl2+hr2)))/((hr1-hl1)
     >     *hl1*(hl1-hl2)*(hl1-hr2))
      d2m(N-1)  =(2.0*(hl2*hr2+hl1*(hl2+hr2)))/(hr1*(hr1-hl1)
     >     *(hr1-hl2)*(hr1-hr2))
      d2r1(N-1) =(2.0*(hl2*hr2+hl1*(hl2+hr2)+hr1*(hl1+hl2+hr2)))
     >     /(hr1*hl1*hl2*hr2)
      d2r2(N-1) =-(2.0*(hl1*hl2+hr1*(hl1+hl2)))/((hr1-hr2)
     >     *hr2*(-hl1+hr2)*(-hl2+hr2))

      ! try 3rd order approx
      !hm1 = zz(2)-zz(1)
      !hp1 = zz(3)-zz(2)
      !hp2 = zz(4)-zz(2)
      !d2l2(2) = 2.0*(hp1+hp2)/(hm1*(hm1+hp1)*(hm1+hp2))
      !d2l1(2) = 2.0*(hm1-hp1-hp2)/(hm1*hp1*hp2)
      !d2m(2)  = 2.0*(hm1-hp2)/(hp1*(hm1+hp1)*(hp1-hp2))
      !d2r1(2) = -2.0*(hm1-hp1)/((hp1-hp2)*hp2*(hm1+hp2))
      !d2r2(2) = 0.0
