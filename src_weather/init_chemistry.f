...
************************************************************************
      ...
      use CHEMISTRY,ONLY: NMOLdim,NMOLE,NELM,catm,cmol,molmass,
     ...
     &    Ti,V,Cr,Mn,Fe,Co,Ni,Cu,Zn,Ga,Ge,As,Se,Br,Kr,Rb,Sr,Y,Zr,W
      ...
      print*
      print*,"init chemistry for"//trim(elements_select)
      print*,"========================================================="
 ...
 100  NELM = 0
      ...
      do loop=1,4
        ...
        print*,'reading kp-data from '//trim(filename)//" ..."
        ...
        do ii=1,NMOLdim
          ...
          do j=1,m_kind(0,i)
            ...
            if (index(elements_select,cel(j))<=0) found=.false. 
 ...
 200    close(12)
      ...
      do i=1,NMOLE
        ...
        do j=1,m_kind(0,i)
          e = m_kind(j,i)
          if (e==el) then
            molmass(i) = molmass(i) + mel*m_anz(j,i)
          else
            molmass(i) = molmass(i) + mass(elnum(e))*m_anz(j,i)
          endif
        enddo  
