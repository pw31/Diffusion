...
***********************************************************************
      ...
      use CHEMISTRY,ONLY: NMOLE,NELEM,NELM,elnum,elion,el,charge
      use EXCHANGE,ONLY: nel,nat,nion,nmol,ipoint
      implicit none
      ...
      do i=1,NELM
        ...
        epsi(i) = eps(elnum(i))
#ifdef CHECK_NAN
        if ((epsi(i).lt.0.Q0).or.IS_NAN(REAL(epsi(i)))) then
          print*,"*** eps=NaN in ggchem"
          print*,ipoint,nHges,Tg
          print*,eps
          stop
        endif
#endif
